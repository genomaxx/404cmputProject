# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-03-27 06:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('githubusername', models.CharField(blank=True, max_length=200)),
                ('UID', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('apiID', models.CharField(blank=True, max_length=200)),
                ('github', models.CharField(blank=True, max_length=200)),
                ('host', models.CharField(default='http://mysterious-falls-21653.herokuapp.com/api/', max_length=200)),
