    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('privacyLevel', models.IntegerField(choices=[(0, b'Public'), (1, b'Friends'), (2, b'Friends of friends'), (3, b'Private message'), (4, b'Private'), (5, b'Unlisted')], default=0)),
                ...
                ('contentType', models.CharField(choices=[(b'text/plain', b'Plain Text'), (b'text/markdown', b'Markdown')], default=b'text/plain', max_length=128)),
